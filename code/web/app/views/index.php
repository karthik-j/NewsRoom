	...
	<!-- CONTAIN -->
		...
		<div id="home" class="inner_class">
			...
			<div id="home_video" class="grid_11">
				<!-- VIMEO start-->
				<div class="video">
				<img src="images/play_button_overlay.jpg" width="620" height="345"></img>
				</div>
				<!-- VIMEO end -->
			...
			<div id="home_slider" class="grid_5">
				<div id="slider" style="position: relative;">
					<div class="slider1" style="position: absolute; top: 0px; left: 0px; display: block; z-index: 4; width: 282px; height: 316px; opacity: 1;">
						...
						<span class="CF_ColLight"><cufon class="cufon cufon-canvas" alt="NEWS " style="width: 37px; height: 17px;"><canvas width="50" height="18" style="width: 50px; height: 18px; top: -1px; left: 0px;"></canvas><cufontext>NEWS </cufontext></cufon><cufon class="cufon cufon-canvas" alt="ROOM " style="width: 24px; height: 17px;"><canvas width="38" height="18" style="width: 38px; height: 18px; top: -1px; left: 0px;"></canvas><cufontext>ROOM </cufontext></cufon></span>
						<div class="dashed"></div>
						<div class="slider_text">
						<p>Newsroom is a gateway to the Wikipedia articles, the latest breaking news stories and the webposts across the social media.</p>
						</div>
					</div>
					<div class="slider1" style="position: absolute; top: 0px; left: 0px; display: block; z-index: 4; width: 282px; height: 316px; opacity: 1;">
						...
						<span class="CF_ColLight"><cufon class="cufon cufon-canvas" alt="NEWSROOM FEATURE" style="width: 37px; height: 17px;"><canvas width="50" height="18" style="width: 50px; height: 18px; top: -1px; left: 0px;"></canvas><cufontext>NEWSROOM FEATURE</cufontext></cufon></span>
						<div class="dashed"></div>
						<div class="slider_text">
						<p>Searching for something on the Web, but can't spell it? Don't worry.  Newsroom's "Did you mean" feature provides alternative suggestions when you may have misspelled a search term.</p>
						</div>
					</div>
					<div class="slider1" style="position: absolute; top: 0px; left: 0px; display: block; z-index: 4; width: 282px; height: 316px; opacity: 1;">
						...
						<div class="dashed"></div>
						<div class="slider_text">
						<p>As you type in the search box, you can find information quickly by seeing search predictions that might be similar to the search terms you're typing. For example, as you start to type [new york], you may see other popular New York-related searches. When you click a search prediction, you do a search using that prediction as your search term.</p>
						</div>
					</div>
				</div>
			</div>
...
<div class="clear"></div>
	...
	<a class="w-search-show" href="javascript:void(0)" style="width:100%;">
								...
								<input placeholder="Enter your query text" size="80" style="font-size:15px;border: 1px solid #ccc;height:20px;vertical-align:bottom;display:inline;margin:4px 5px 0px 0px;" type="text">
								</div>    
								<div>
									<button style="background-color: #208dcc;padding: 4px 9px;float: left;">Search</button>
								</div>
								</center>
